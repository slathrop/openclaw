  ...
  return html`
    <section class="grid grid-cols-2">
      <div class="card">
        ...
        <div class="stack" style="margin-top: 12px;">
          <div>
            ...
            ${securitySummary ? html`<div class="callout ${securityTone}" style="margin-top: 8px;">
                  Security audit: ${securityLabel}${info > 0 ? ` \xB7 ${info} info` : ''}. Run
      ...
      <div class="card">
        ...
        ${props.callError ? html`<div class="callout danger" style="margin-top: 12px;">
              ${props.callError}
            </div>` : nothing}
