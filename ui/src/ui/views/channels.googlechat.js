...
function renderGoogleChatCard(params) {
    ...
    <div class="card">
      ...
      <div class="status-list" style="margin-top: 16px;">
        ...
        <div>
          ...
          <span>
            ${googleChat?.audienceType ? `${googleChat.audienceType}${googleChat.audience ? ` \xB7 ${googleChat.audience}` : ''}` : 'n/a'}
          </span>
        </div>
        <div>
      ...
      ${googleChat?.lastError ? html`<div class="callout danger" style="margin-top: 12px;">
            ${googleChat.lastError}
          </div>` : nothing}

      ${googleChat?.probe ? html`<div class="callout" style="margin-top: 12px;">
