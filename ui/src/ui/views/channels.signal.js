...
function renderSignalCard(params) {
  ...
  return html`
    <div class="card">
      ...
      ${signal?.lastError ? html`<div class="callout danger" style="margin-top: 12px;">
            ${signal.lastError}
          </div>` : nothing}

      ${signal?.probe ? html`<div class="callout" style="margin-top: 12px;">
