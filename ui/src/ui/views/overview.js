...
import { formatAgo, formatDurationMs } from '../format.js';
  ...
  return html`
    <section class="grid grid-cols-2">
      ...
      <div class="card">
        ...
        ${props.lastError ? html`<div class="callout danger" style="margin-top: 14px;">
    ...
    <section class="grid grid-cols-3" style="margin-top: 18px;">
      ...
      <div class="card stat-card">
        ...
        <div class="stat-value">
          ${props.cronEnabled === null || props.cronEnabled === undefined ? 'n/a' : props.cronEnabled ? 'Enabled' : 'Disabled'}
        </div>
