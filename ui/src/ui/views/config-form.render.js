...
function renderConfigForm(props) {
  ...
  if (activeSection && activeSubsection && filteredEntries.length === 1) {
    ...
    if (sectionSchema && schemaType(sectionSchema) === 'object' && sectionSchema.properties && sectionSchema.properties[activeSubsection]) {
      subsectionContext = {
  ...
  return html`
    <div class="config-form config-form--modern">
      ${subsectionContext ? (() => {
        ...
        const scopedValue = sectionValue && typeof sectionValue === 'object' ? sectionValue[subsectionKey] : void 0;
