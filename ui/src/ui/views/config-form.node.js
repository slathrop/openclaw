...
function renderNode(params) {
  ...
  if (schema.anyOf || schema.oneOf) {
    ...
    const allLiterals = literals.every((v) => v !== void 0);
        ...
        <div class="cfg-field">
          ...
          <div class="cfg-segmented">
            ${literals.map(
              ...
              <button
                type="button"
                class="cfg-segmented__btn ${// oxlint-disable typescript/no-base-to-string
  ...
  String(lit)}
    ...
    if ([...normalizedTypes].every((v) => ['string', 'number', 'boolean'].includes(v))) {
      ...
      if (hasBoolean && normalizedTypes.size === 1) {
        return renderNode({
          ...params,
          schema: { ...schema, type: 'boolean', anyOf: void 0, oneOf: void 0 }
        });
      }
...
function renderTextInput(params) {
  ...
  const placeholder = hint?.placeholder ?? // oxlint-disable typescript/no-base-to-string
  (isSensitive ? '\u2022\u2022\u2022\u2022' : schema.default !== void 0 ? `Default: ${String(schema.default)}` : '');
    ...
    <div class="cfg-field">
      ...
      <select
        ...
        @change=${(e) => {
          ...
          onPatch(path, val === unset ? void 0 : options[Number(val)]);
        }}
      >
