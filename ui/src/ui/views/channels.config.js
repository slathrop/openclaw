...
import { analyzeConfigSchema, renderNode, schemaType } from './config-form.js';
...
const EXTRA_CHANNEL_FIELDS = ['groupPolicy', 'streamMode', 'dmPolicy'];
function formatExtraValue(raw) {
...
function renderExtraChannelFields(value) {
