...
function renderWhatsAppCard(params) {
    ...
    <div class="card">
      ...
      <div class="status-list" style="margin-top: 16px;">
        ...
        <div>
          ...
          <span>
            ${whatsapp?.authAgeMs !== null && whatsapp?.authAgeMs !== undefined ? formatDuration(whatsapp.authAgeMs) : 'n/a'}
          </span>
        </div>
      </div>

      ${whatsapp?.lastError ? html`<div class="callout danger" style="margin-top: 12px;">
            ${whatsapp.lastError}
          </div>` : nothing}

      ${props.whatsappMessage ? html`<div class="callout" style="margin-top: 12px;">
            ${props.whatsappMessage}
          </div>` : nothing}

      ${props.whatsappQrDataUrl ? html`<div class="qr-wrap">
