...
vi.mock('./chat.js', () => ({
  editBlueBubblesMessage: vi.fn().mockResolvedValue(void 0),
  unsendBlueBubblesMessage: vi.fn().mockResolvedValue(void 0),
  renameBlueBubblesChat: vi.fn().mockResolvedValue(void 0),
  setGroupIconBlueBubbles: vi.fn().mockResolvedValue(void 0),
  addBlueBubblesParticipant: vi.fn().mockResolvedValue(void 0),
  removeBlueBubblesParticipant: vi.fn().mockResolvedValue(void 0),
  leaveBlueBubblesChat: vi.fn().mockResolvedValue(void 0)
}));
vi.mock('./attachments.js', () => ({
  sendBlueBubblesAttachment: vi.fn().mockResolvedValue({ messageId: 'att-msg-123' })
}));
vi.mock('./monitor.js', () => ({
  resolveBlueBubblesMessageId: vi.fn((id) => id)
}));
  ...
  describe('handleAction', () => {
    ...
    it('accepts message param for edit action', async () => {
      ...
      expect(editBlueBubblesMessage).toHaveBeenCalledWith(
        'msg-123',
        'updated',
        expect.objectContaining({ cfg, accountId: void 0 })
      );
    });
