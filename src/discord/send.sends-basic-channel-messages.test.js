...
describe('sendMessageDiscord', () => {
  ...
  it('adds missing permission hints on 50013', async () => {
    ...
    }).mockResolvedValueOnce({ id: 'bot1' }).mockResolvedValueOnce({
      id: 'guild1',
...
describe('fetchReactionsDiscord', () => {
  ...
  it('returns reactions with users', async () => {
    ...
    }).mockResolvedValueOnce([{ id: 'u1', username: 'alpha', discriminator: '0001' }]).mockResolvedValueOnce([{ id: 'u2', username: 'beta' }]);
