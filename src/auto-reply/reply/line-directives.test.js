...
describe('parseLineDirectives', () => {
  ...
  describe('media_player', () => {
    it('parses media_player with all fields', () => {
      ...
      expect(flexMessage?.altText).toBe('\u{1F3B5} Bohemian Rhapsody - Queen');
    ...
    it('parses media_player with minimal fields', () => {
      ...
      const flexMessage = getLineData(result).flexMessage;
      expect(flexMessage).toBeDefined();
      expect(flexMessage?.altText).toBe('\u{1F3B5} Unknown Track');
    });
  ...
  describe('event', () => {
    it('parses event with all fields', () => {
      ...
      const flexMessage = getLineData(result).flexMessage;
      expect(flexMessage).toBeDefined();
      expect(flexMessage?.altText).toBe('\u{1F4C5} Team Meeting - January 24, 2026 2:00 PM - 3:00 PM');
    });
    it('parses event with minimal fields', () => {
      ...
      const flexMessage = getLineData(result).flexMessage;
      expect(flexMessage).toBeDefined();
      expect(flexMessage?.altText).toBe('\u{1F4C5} Birthday Party - March 15');
    });
  });
  describe('agenda', () => {
    it('parses agenda with multiple events', () => {
      ...
      const flexMessage = getLineData(result).flexMessage;
      expect(flexMessage).toBeDefined();
      expect(flexMessage?.altText).toBe("\u{1F4CB} Today's Schedule (3 events)");
    });
    it('parses agenda with events without times', () => {
      ...
      const flexMessage = getLineData(result).flexMessage;
      expect(flexMessage).toBeDefined();
      expect(flexMessage?.altText).toBe('\u{1F4CB} Tasks (3 events)');
    });
  });
  describe('device', () => {
    it('parses device with controls', () => {
      ...
      const flexMessage = getLineData(result).flexMessage;
      expect(flexMessage).toBeDefined();
      expect(flexMessage?.altText).toBe('\u{1F4F1} TV: Playing');
    });
    it('parses device with minimal fields', () => {
      ...
      const flexMessage = getLineData(result).flexMessage;
      expect(flexMessage).toBeDefined();
      expect(flexMessage?.altText).toBe('\u{1F4F1} Speaker');
    });
  });
