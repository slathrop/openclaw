...
function baseAliasIndex() {
  return { byAlias: /* @__PURE__ */ new Map(), byKey: /* @__PURE__ */ new Map() };
}
function baseConfig() {
  return {
    commands: { text: true },
...
describe('/model chat UX', () => {
  ...
  it('auto-applies closest match for typos', () => {
    ...
    const resolved = resolveModelSelectionFromDirective({
      ...
      defaultModel: 'claude-opus-4-5',
      aliasIndex: baseAliasIndex(),
      allowedModelKeys: /* @__PURE__ */ new Set(['anthropic/claude-opus-4-5']),
...
describe('handleDirectiveOnly model persist behavior (fixes #1435)', () => {
  const allowedModelKeys = /* @__PURE__ */ new Set(['anthropic/claude-opus-4-5', 'openai/gpt-4o']);
