...
describe('formatInboundBodyWithSenderMeta', () => {
  ...
  it('appends with a real newline even if the body contains literal \\n', () => {
    const ctx = { ChatType: 'group', SenderName: 'Bob', SenderId: '+222' };
