/** @module plugins/update - Plugin update checking and installation. */
    ...
    if (params.dryRun) {
      ...
      if (currentVersion && probe.version && currentVersion === probe.version) {
        outcomes.push({
          ...
          message: `${pluginId} is up to date (${currentLabel2}).`
        });
      } else {
        outcomes.push({
          pluginId,
          ...
          currentVersion: currentVersion ?? void 0,
          nextVersion: probe.version ?? void 0,
          message: `Would update ${pluginId}: ${currentLabel2} -> ${nextVersion2}.`
        });
      }
      continue;
    }
