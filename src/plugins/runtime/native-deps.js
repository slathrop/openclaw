/**
 * @param params
 * @module plugins/runtime/native-deps - Native dependency detection and hint formatting.
 */
function formatNativeDependencyHint(params) {
  ...
  const approveBuildsCommand = params.approveBuildsCommand ?? (manager === 'pnpm' ? `pnpm approve-builds (select ${params.packageName})` : void 0);
