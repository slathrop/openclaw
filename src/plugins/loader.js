/** @module plugins/loader - Plugin loader with jiti runtime compilation. */
...
const resolvePluginSdkAlias = () => {
  try {
    ...
    for (let i = 0; i < 6; i += 1) {
      ...
      const orderedCandidates = isProduction ? isTest ? [distCandidate, srcCandidate] : [distCandidate] : [srcCandidate, distCandidate];
  ...
  } catch { /* workspace root not found */ }
  return null;
};
