 ...
 * System prompt builder combining skills, memory, and identity sections.
 */
...
function buildAgentSystemPrompt(params) {
  ...
  const lines = [
    ...
    userTimezone ? 'If you need the current date, time, or day of week, run session_status (\u{1F4CA} session_status).' : '',
    '## Workspace',
