/**
 * OAuth profile ID mismatch detection and repair for legacy default profiles.
 * @module agents/auth-profiles/repair
 */
...
function suggestOAuthProfileIdForLegacyDefault(params) {
  ...
  if (legacyCfg && normalizeProviderId(legacyCfg.provider) === providerKey && legacyCfg.mode !== 'oauth') {
    return null;
  }
