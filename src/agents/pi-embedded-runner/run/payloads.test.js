...
describe('buildEmbeddedRunPayloads', () => {
  const errorJson = '{"type":"error","error":{"details":null,"type":"overloaded_error","message":"Overloaded"},"request_id":"req_011CX7DwS7tSvggaNHmefwWg"}';
  ...
  it('suppresses raw error JSON even when errorMessage is missing', () => {
    const lastAssistant = makeAssistant({ errorMessage: void 0 });
    const payloads = buildEmbeddedRunPayloads({
      assistantTexts: [errorJsonPretty],
      toolMetas: [],
      lastAssistant,
