/**
 * @module subagent-announce-queue
 * Batched announcement queue for subagent lifecycle events.
 */
...
${item.prompt}`.trim()
        ...
        if (summaryPrompt) {
          ...
          await queue.send({ ...next2, prompt: summaryPrompt });
          continue;
        }
