 ...
 * Agent identity avatar generation and display.
 * @typedef {object} AvatarConfig - Agent avatar configuration.
 * @property
 */
...
const ALLOWED_AVATAR_EXTS = /* @__PURE__ */ new Set(['.png', '.jpg', '.jpeg', '.gif', '.webp', '.svg']);
...
function resolveLocalAvatarPath(params) {
  ...
  const resolved = raw.startsWith('~') || path.isAbsolute(raw) ? resolveUserPath(raw) : path.resolve(workspaceRoot, raw);
