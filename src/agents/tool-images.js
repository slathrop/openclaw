/**
 * @module tool-images
 * Image resizing, MIME sniffing, and content block construction for tools.
 */
...
async function resizeImageBase64IfNeeded(params) {
  ...
  const sideGrid = [sideStart, 1800, 1600, 1400, 1200, 1e3, 800].map((v) => Math.min(params.maxDimensionPx, v)).filter((v, i, arr) => v > 0 && arr.indexOf(v) === i).toSorted((a, b) => b - a);
  let smallest = null;
