/**
 * @module pi-embedded-utils
 * Utility functions for embedded Pi session text processing.
 */
...
function extractAssistantText(msg) {
  ...
  const blocks = Array.isArray(msg.content) ? msg.content.filter(isTextBlock).map(
    (c) => stripThinkingTagsFromText(
