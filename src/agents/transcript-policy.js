/**
 * @module transcript-policy
 * Model-specific transcript formatting policy (turn ordering, roles).
 */
...
const OPENAI_MODEL_APIS = /* @__PURE__ */ new Set([
  'openai',
  'openai-completions',
  'openai-responses',
  'openai-codex-responses'
]);
const OPENAI_PROVIDERS = /* @__PURE__ */ new Set(['openai', 'openai-codex']);
...
function resolveTranscriptPolicy(params) {
  ...
  const toolCallIdMode = isMistral ? 'strict9' : sanitizeToolCallIds ? 'strict' : void 0;
  const repairToolUseResultPairing = isGoogle || isAnthropic;
  const sanitizeThoughtSignatures = isOpenRouterGemini ? { allowBase64Only: true, includeCamelCase: true } : void 0;
  ...
  return {
    ...
    sanitizeThoughtSignatures: isOpenAi ? void 0 : sanitizeThoughtSignatures,
