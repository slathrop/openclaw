...
`,
  ...
  it('throws when ZAI API key is missing', async () => {
    ...
    try {
      ...
      if (previousZai === void 0) {
        delete process.env.ZAI_API_KEY;
      } else {
        process.env.ZAI_API_KEY = previousZai;
      }
      if (previousLegacy === void 0) {
        delete process.env.Z_AI_API_KEY;
      } else {
