/**
 * @module pi-tools.policy
 * Tool policy compilation and matching for Pi agent tool access control.
 */
...
function unionAllow(base, extra) {
  ...
  if (!Array.isArray(base) || base.length === 0) {
    return Array.from(/* @__PURE__ */ new Set(['*', ...extra]));
  }
  return Array.from(/* @__PURE__ */ new Set([...base, ...extra]));
}
