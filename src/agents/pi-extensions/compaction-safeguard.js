/**
 * Compaction safeguard extension for context window management.
 * @module agents/pi-extensions/compaction-safeguard
 */
import {
  BASE_CHUNK_RATIO,
  MIN_CHUNK_RATIO,
          ...
          if (pruned.droppedChunks > 0) {
            ...
            console.warn(
              `Compaction safeguard: new content uses ${newContentRatio.toFixed(
                1
              )}% of context; dropped ${pruned.droppedChunks} older chunk(s) (${pruned.droppedMessages} messages) to fit history budget.`
            );
