...
describe('buildWorkspaceSkillCommandSpecs', () => {
  it('sanitizes and de-duplicates command names', async () => {
    ...
    const commands = buildWorkspaceSkillCommandSpecs(workspaceDir, {
      ...
      reservedNames: /* @__PURE__ */ new Set(['help'])
    });
  ...
  it('truncates descriptions longer than 100 characters for Discord compatibility', async () => {
    const workspaceDir = await makeWorkspace();
    const longDescription = "This is a very long description that exceeds Discord's 100 character limit for slash command descriptions and should be truncated";
    await writeSkill({
