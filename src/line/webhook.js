/**
 * LINE webhook HTTP server
 * @typedef {object} LineWebhookOptions
 * @property {string} channelSecret
 * @property {(events: import("@line/bot-sdk").WebhookEvent[]) => void | Promise<void>} onEvents
 * @property {string} [path]
 * @typedef {object} StartLineWebhookOptions
