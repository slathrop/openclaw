 ...
 * @typedef {object} LineHandlerContext
 * @property {import("./types.js").ResolvedLineAccount} account
 * @property {import("../config/config.js").OpenClawConfig} cfg
 * @property {import("@line/bot-sdk").messagingApi.MessagingApiClient} client
 * @property {import("@line/bot-sdk").messagingApi.MessagingApiBlobClient} blobClient
 */
