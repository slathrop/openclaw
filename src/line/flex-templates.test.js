...
describe('createImageCard', () => {
  it('creates a card with hero image', () => {
    ...
    expect(card.hero.url).toBe('https://example.com/image.jpg');
  });
  ...
  it('applies custom aspect ratio', () => {
    const card = createImageCard('https://example.com/img.jpg', 'Title', void 0, {
      aspectRatio: '16:9'
    });
    expect(card.hero.aspectRatio).toBe('16:9');
  });
});
describe('createActionCard', () => {
  ...
  it('includes hero image when provided', () => {
    ...
    expect(card.hero).toBeDefined();
    expect(card.hero.url).toBe('https://example.com/hero.jpg');
  });
});
...
describe('createMediaPlayerCard', () => {
  ...
  it('includes album art when provided', () => {
    ...
    expect(card.hero).toBeDefined();
    expect(card.hero.url).toBe('https://example.com/album.jpg');
  });
...
describe('createEventCard', () => {
  ...
  it('includes action when provided', () => {
    ...
    expect(card.body).toBeDefined();
    expect(card.body.action).toBeDefined();
  });
