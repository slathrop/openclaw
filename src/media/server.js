...
function attachMediaRoutes(app, ttlMs = DEFAULT_TTL_MS, _runtime = defaultRuntime) {
...
async function startMediaServer(port, ttlMs = DEFAULT_TTL_MS, runtime = defaultRuntime) {
  const app = express();
