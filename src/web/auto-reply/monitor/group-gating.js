...
function isOwnerSender(baseMentionConfig, msg) {
  ...
  const owners = resolveOwnerList(baseMentionConfig, msg.selfE164 ?? void 0);
...
function applyGroupGating(params) {
  ...
  const implicitMention = Boolean(
    selfJid && replySenderJid && selfJid === replySenderJid || selfE164 && replySenderE164 && selfE164 === replySenderE164
  );
