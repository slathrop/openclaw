...
function createSyntaxTheme(fallback) {
  return {
    ...
    // purple - if, const, function, etc.
    built_in: chalk.hex('#4EC9B0'),
    // teal - console, Math, etc.
    ...
    // light blue - parameters
    comment: chalk.hex('#6A9955'),
    // green - comments
    doctag: chalk.hex('#608B4E'),
    // darker green - jsdoc tags
    meta: chalk.hex('#9CDCFE'),
    // light blue - meta/preprocessor
