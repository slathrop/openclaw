...
function registerWebhooksCli(program) {
  const webhooks = program.command('webhooks').description('Webhook helpers and integrations').addHelpText(
    'after',
    () => `
...
__name(registerWebhooksCli, 'registerWebhooksCli');
...
__name(parseGmailSetupOptions, 'parseGmailSetupOptions');
...
__name(parseGmailRunOptions, 'parseGmailRunOptions');
