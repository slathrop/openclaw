...
const modelsStatusCommand = vi.fn().mockResolvedValue(void 0);
vi.mock('../commands/models.js', async () => {
  const actual = await vi.importActual('../commands/models.js');
  return {
    ...actual,
...
describe('models cli', () => {
  ...
  it('registers github-copilot login command', { timeout: 6e4 }, async () => {
