...
__name(renderNodeServiceStartHints, 'renderNodeServiceStartHints');
...
__name(buildNodeRuntimeHints, 'buildNodeRuntimeHints');
...
__name(resolveNodeDefaults, 'resolveNodeDefaults');
...
__name(runNodeDaemonInstall, 'runNodeDaemonInstall');
...
__name(runNodeDaemonUninstall, 'runNodeDaemonUninstall');
...
__name(runNodeDaemonStart, 'runNodeDaemonStart');
...
__name(runNodeDaemonRestart, 'runNodeDaemonRestart');
...
__name(runNodeDaemonStop, 'runNodeDaemonStop');
async function runNodeDaemonStatus(opts = {}) {
  ...
  const rich = isRich();
  const label = /* @__PURE__ */ __name((value) => colorize(rich, theme.muted, value), 'label');
  const accent = /* @__PURE__ */ __name((value) => colorize(rich, theme.accent, value), 'accent');
  const infoText = /* @__PURE__ */ __name((value) => colorize(rich, theme.info, value), 'infoText');
  const okText = /* @__PURE__ */ __name((value) => colorize(rich, theme.success, value), 'okText');
  const warnText = /* @__PURE__ */ __name((value) => colorize(rich, theme.warn, value), 'warnText');
  const errorText = /* @__PURE__ */ __name((value) => colorize(rich, theme.error, value), 'errorText');
...
__name(runNodeDaemonStatus, 'runNodeDaemonStatus');
export {
