...
__name(isIndexSegment, 'isIndexSegment');
...
__name(unsetAtPath, 'unsetAtPath');
...
__name(loadValidConfig, 'loadValidConfig');
function registerConfigCli(program) {
  const cmd = program.command('config').description('Config helpers (get/set/unset). Run without subcommand for the wizard.').addHelpText(
    'after',
    () => `
...
__name(registerConfigCli, 'registerConfigCli');
export {
  registerConfigCli
};
