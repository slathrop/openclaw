...
__name(runChannelsCommand, 'runChannelsCommand');
...
__name(runChannelsCommandWithDanger, 'runChannelsCommandWithDanger');
function registerChannelsCli(program) {
  const channelNames = formatCliChannelOptions();
  const channels = program.command('channels').description('Manage chat channel accounts').addHelpText(
    'after',
    () => `
...
__name(registerChannelsCli, 'registerChannelsCli');
export {
  registerChannelsCli
};
