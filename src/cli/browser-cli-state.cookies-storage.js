...
function registerBrowserCookiesAndStorageCommands(browser, parentOpts) {
  ...
  __name(registerStorageKind, 'registerStorageKind');
  registerStorageKind('local');
  registerStorageKind('session');
}
__name(registerBrowserCookiesAndStorageCommands, 'registerBrowserCookiesAndStorageCommands');
export {
  registerBrowserCookiesAndStorageCommands
};
