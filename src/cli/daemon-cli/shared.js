...
__name(parsePortFromArgs, 'parsePortFromArgs');
...
__name(pickProbeHostForBind, 'pickProbeHostForBind');
...
__name(normalizeListenerAddress, 'normalizeListenerAddress');
function formatRuntimeStatus(runtime) {
  ...
  if (runtime.lastExitStatus !== void 0) {
...
__name(formatRuntimeStatus, 'formatRuntimeStatus');
...
__name(renderRuntimeHints, 'renderRuntimeHints');
...
__name(renderGatewayServiceStartHints, 'renderGatewayServiceStartHints');
export {
  filterDaemonEnv,
  formatRuntimeStatus,
