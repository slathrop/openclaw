...
__name(sanitizeDaemonStatusForJson, 'sanitizeDaemonStatusForJson');
function printDaemonStatus(status, opts) {
  ...
  const spacer = /* @__PURE__ */ __name(() => defaultRuntime.log(''), 'spacer');
  ...
  try {
    ...
    // Best-effort log path display; ignore resolution failures
  }
...
__name(printDaemonStatus, 'printDaemonStatus');
export {
  printDaemonStatus
};
