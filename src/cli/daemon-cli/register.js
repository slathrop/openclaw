...
function registerDaemonCli(program) {
  const daemon = program.command('daemon').description('Manage the Gateway service (launchd/systemd/schtasks)').addHelpText(
    'after',
    () => `
...
__name(registerDaemonCli, 'registerDaemonCli');
export {
  registerDaemonCli
};
