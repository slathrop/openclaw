...
__name(createMockSkill, 'createMockSkill');
...
__name(createMockReport, 'createMockReport');
describe('skills-cli', () => {
  describe('formatSkillsList', () => {
    ...
    it('formats skills list with eligible skill', () => {
      ...
      expect(output).toContain('\u{1F4F8}');
