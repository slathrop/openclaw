...
function registerNodesLocationCommands(nodes) {
  ...
  nodesCallOpts(
    location.command('get').description('Fetch the current location from a node').requiredOption('--node <idOrNameOrIp>', 'Node id, name, or IP').option('--max-age <ms>', 'Use cached location newer than this (ms)').option(
...
__name(registerNodesLocationCommands, 'registerNodesLocationCommands');
export {
