/**
 * Exec approval forwarding to messaging channels.
 *
 * Forwards exec approval requests and resolutions to configured messaging
 * targets (session channel, explicit targets, or both). Handles expiration
 * timeouts and deduplication of delivery targets.
 * SECURITY: Validates forwarding config and filters by agent/session before sending.
 */
 ...
 * @typedef {{
 *   id: string,
 *   decision: import('./exec-approvals.js').ExecApprovalDecision,
...
/**
 * @typedef {{
 *   getConfig?: () => import('../config/config.js').OpenClawConfig,
 *   deliver?: typeof deliverOutboundPayloads,
 *   nowMs?: () => number,
 *   resolveSessionTarget?: (params: { cfg: import('../config/config.js').OpenClawConfig, request: ExecApprovalRequest }) => import('../config/types.approvals.js').ExecApprovalForwardTarget | null
 * }} ExecApprovalForwarderDeps
 */
...
/**
 * Creates an exec approval forwarder that handles forwarding approval
 * requests and resolutions to messaging channels.
 * @param {ExecApprovalForwarderDeps} [deps]
 * @returns {ExecApprovalForwarder}
 */
...
/**
 * @param {{ config?: import('../config/types.approvals.js').ExecApprovalForwardingConfig, request: ExecApprovalRequest }} params
 * @returns {boolean}
 */
