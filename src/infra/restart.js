 ...
 *
 * Provides platform-specific restart (launchctl on macOS, systemd on Linux),
 * SIGUSR1-based authorized restart scheduling, and restart authorization tracking.
 */
...
/**
 * Trigger a gateway restart using the platform supervisor.
 * @returns {RestartAttempt}
 */
...
/**
 * Schedule a SIGUSR1 restart with optional delay.
 * @param {{ delayMs?: number, reason?: string }} [opts]
 * @returns {ScheduledRestart}
 */
