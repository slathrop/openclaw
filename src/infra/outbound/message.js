/**
 * SECURITY: High-level message and poll sending API.
 * Validates channel availability, normalizes payloads, and routes
 * through direct delivery or gateway based on channel configuration.
 * @module
 */
...
async function sendMessage(params) {
  ...
  const channel = params.channel?.trim() ? normalizeChannelId(params.channel) : (await resolveMessageChannelSelection({ cfg })).channel;
  if (!channel) {
