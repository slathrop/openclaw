/**
 * Heartbeat runner with scheduling, active hours, and delivery logic.
 *
 * Manages periodic heartbeat execution across multiple agents, including
 * active hours enforcement, delivery target resolution, duplicate
 * suppression, reasoning payload handling, and session management.
 */
...
/**
 * @typedef {object} HeartbeatSummary
 ...
 * @property {number} ackMaxChars
 */

/**
 * @typedef {object} HeartbeatRunner
 * @property {() => void} stop
 * @property {(cfg: import('../config/config.js').OpenClawConfig) => void} updateConfig
 */
...
/**
 * Enables or disables heartbeat execution globally.
...
/**
 * Checks if heartbeat is enabled for a given agent.
 * @param {import('../config/config.js').OpenClawConfig} cfg
...
/**
 * Resolves a full heartbeat summary for a given agent.
 * @param {import('../config/config.js').OpenClawConfig} cfg
 * @param {string} [agentId]
 * @returns {HeartbeatSummary}
 */
...
/**
 * @param {import('../config/config.js').OpenClawConfig} cfg
 * @returns {Array<{ agentId: string, heartbeat?: object }>}
 */
...
/**
 * Resolves the heartbeat interval in milliseconds.
 * @param {import('../config/config.js').OpenClawConfig} cfg
 * @param {string} [overrideEvery]
 * @param {object} [heartbeat]
 * @returns {number | null}
 */
...
/**
 * Resolves the heartbeat prompt text.
 * @param {import('../config/config.js').OpenClawConfig} cfg
 * @param {object} [heartbeat]
 * @returns {string}
 */
 ...
 * @param {string} [agentId]
 * @param {object} [heartbeat]
 * @returns {{ sessionKey: string, storePath: string, store: object, entry: object | undefined }}
 */
...
/**
 * @param {object | object[] | undefined} replyResult
 * @returns {object | undefined}
 */
 ...
 * @param {string | undefined} responsePrefix
 * @param {number} ackMaxChars
 * @returns {{ shouldSkip: boolean, text: string, hasMedia: boolean }}
 */
...
/**
 * Runs a single heartbeat cycle for an agent.
 * @param {object} opts
 * @param {import('../config/config.js').OpenClawConfig} [opts.cfg]
 * @param {string} [opts.agentId]
 * @param {object} [opts.heartbeat]
 * @param {string} [opts.reason]
 * @param {object} [opts.deps]
 * @returns {Promise<import('./heartbeat-wake.js').HeartbeatRunResult>}
 */
...
/**
 * Starts the heartbeat runner with scheduling and config updates.
 * @param {object} opts
 * @param {import('../config/config.js').OpenClawConfig} [opts.cfg]
 * @param {import('../runtime.js').RuntimeEnv} [opts.runtime]
 * @param {AbortSignal} [opts.abortSignal]
 * @param {typeof runHeartbeatOnce} [opts.runOnce]
 * @returns {HeartbeatRunner}
 */
export function startHeartbeatRunner(opts) {
  ...
  /** @type {import('./heartbeat-wake.js').HeartbeatWakeHandler} */
