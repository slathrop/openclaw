/**
 * Port usage inspection for diagnostics and conflict detection.
 *
 * Inspects TCP port usage on both Unix (lsof) and Windows (netstat/tasklist)
 * platforms. Resolves process details (command line, user, image name) and
 * provides structured diagnostics with actionable hints.
 */
...
/**
 * Runs a command and returns a safe result object.
 * @param {string[]} argv
...
/**
 * Parses lsof field output into port listeners.
 * @param {string} output
 * @returns {import('./ports-types.js').PortListener[]}
 */
...
/**
 * @param {number} port
 * @returns {Promise<{ listeners: import('./ports-types.js').PortListener[], detail?: string, errors: string[] }>}
 */
...
/**
 * Parses netstat output to find listeners on a specific port (Windows).
 * @param {string} output
 * @param {number} port
 * @returns {import('./ports-types.js').PortListener[]}
 */
 ...
 * @param {number} port
 * @param {string} host
 * @returns {Promise<import('./ports-types.js').PortUsageStatus | "skip">}
 */
...
/**
 * @param {number} port
 * @returns {Promise<import('./ports-types.js').PortUsageStatus>}
 */
...
/**
 * Inspects TCP port usage, returning listeners, status, and hints.
 * @param {number} port
 * @returns {Promise<import('./ports-types.js').PortUsage>}
 */
