/**
 * Update orchestration flow for git and global package installs.
 *
 * Detects the install kind (git or global npm/pnpm/bun), runs appropriate
 * update steps (fetch, preflight, rebase/checkout, deps install, build),
 * and reports step-by-step progress and results.
 */
...
/**
 * @param {object} opts
 * @returns {Promise<UpdateStepResult>}
 */
...
/**
 * Run a full gateway update (git or global package).
 * @param {object} [opts]
 * @param {string} [opts.cwd]
 * @param {string} [opts.argv1]
 * @param {string} [opts.tag]
 * @param {import('./update-channels.js').UpdateChannel} [opts.channel]
 * @param {number} [opts.timeoutMs]
 * @param {Function} [opts.runCommand]
 * @param {UpdateStepProgress} [opts.progress]
 * @returns {Promise<UpdateRunResult>}
 */
