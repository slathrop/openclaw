/**
 * Runtime environment detection and version guard.
 *
 * Detects the current Node.js runtime, validates minimum version
 * requirements (Node >=22), and provides assertion helpers for
 * early startup validation.
 * SECURITY: Prevents running on unsupported runtimes that may have vulnerabilities.
 */
...
/**
 * Checks if a version meets or exceeds a minimum requirement.
 * @param {{ major: number, minor: number, patch: number } | null} version
 * @param {{ major: number, minor: number, patch: number }} minimum
 * @returns {boolean}
 */
 ...
 * @returns {{ kind: string, version: string | null, execPath: string | null, pathEnv: string }}
 */
...
/**
 * Checks if the detected runtime satisfies minimum requirements.
 * @param {{ kind: string, version: string | null }} details
 * @returns {boolean}
 */
...
/**
 * Asserts that the runtime meets minimum requirements; exits if not.
