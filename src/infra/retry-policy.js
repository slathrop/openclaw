/**
 * Platform-specific retry runners for Discord and Telegram.
 *
 * Wraps the generic retryAsync with rate-limit awareness for each
 * messaging platform, including retry-after header extraction and
...
/**
 * @typedef {(fn: () => Promise<*>, label?: string) => Promise<*>} RetryRunner
 */
...
/**
 * Extracts a retry-after delay from a Telegram error object.
 * @param {unknown} err
...
/**
 * Creates a retry runner configured for Discord rate-limit handling.
 * @param {{
 *   retry?: import('./retry.js').RetryConfig,
 *   configRetry?: import('./retry.js').RetryConfig,
 *   verbose?: boolean
 * }} params
 * @returns {RetryRunner}
 */
...
/**
 * Creates a retry runner configured for Telegram rate-limit and error handling.
 * @param {{
 *   retry?: import('./retry.js').RetryConfig,
 *   configRetry?: import('./retry.js').RetryConfig,
 *   verbose?: boolean,
