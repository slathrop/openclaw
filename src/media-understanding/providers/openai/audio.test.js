...
describe('transcribeOpenAiCompatibleAudio', () => {
  beforeEach(() => {
    ...
    resolvePinnedHostnameWithPolicySpy = vi.spyOn(ssrf, 'resolvePinnedHostnameWithPolicy').mockImplementation(
      (hostname, params) => resolvePinnedHostnameWithPolicy(hostname, { ...params, lookupFn: lookupMock })
    );
  });
  afterEach(() => {
