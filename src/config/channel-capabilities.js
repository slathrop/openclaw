/**
 * @module channel-capabilities
 * Capability detection and resolution for messaging channels.
 */
...
/**
 * Normalizes a capabilities array, filtering empty entries.
...
/**
 * @param {{ cfg?: object, accountId?: string | null }} params
 * @returns {string[] | undefined}
 */
...
/**
 * Resolves capabilities for a channel/account combination.
