/**
 * Agent list and binding Zod validation schemas.
 *
 * Validates the agents (list + defaults), bindings (channel-to-agent routing),
 * broadcast (multi-agent message fan-out), and audio transcription settings.
 */
import { z } from 'zod';
