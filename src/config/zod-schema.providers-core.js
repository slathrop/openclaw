/**
 * Provider-specific channel Zod validation schemas.
 *
 * Defines validation schemas for Telegram, Discord, Google Chat, Slack,
 * Signal, iMessage, BlueBubbles, and MS Teams channel configurations
 * including per-account, per-guild/group, DM policy, webhook, and
 * streaming settings.
 *
 * SECURITY: Enforces DM open-policy wildcard requirements via
 * requireOpenAllowFrom for every channel provider that supports DM policies.
 */
import { z } from 'zod';
import {
