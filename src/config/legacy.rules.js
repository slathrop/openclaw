/**
 * Legacy config detection rules.
 *
 * Each rule identifies a deprecated config key path and provides a
 * user-facing message explaining the migration. Rules are checked in
 * findLegacyConfigIssues() to warn users about outdated config fields
 * before validation. All listed keys have corresponding auto-migrations
 * in legacy.migrations.part-1 through part-3.
 */

/** @type {import('./legacy.shared.js').LegacyConfigRule[]} */
