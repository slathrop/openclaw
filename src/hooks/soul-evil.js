...
function resolveSoulEvilConfigFromHook(entry, log) {
  ...
  if (entry.file !== void 0 && !file) {
    log?.warn?.('soul-evil config: file must be a string');
  }
  let chance;
  if (entry.chance !== void 0) {
