/** @module gateway/server-runtime-config -- Runtime configuration management for the gateway. */
import {
...
async function resolveGatewayRuntimeConfig(params) {
  ...
  return {
    ...
    openResponsesConfig: openResponsesConfig ? { ...openResponsesConfig, enabled: openResponsesEnabled } : void 0,
    controlUiBasePath,
    controlUiRoot,
    resolvedAuth,
    authMode,
