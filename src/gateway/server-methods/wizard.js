/** @module gateway/server-methods/wizard -- Setup wizard RPC method handler. */
...
const wizardHandlers = {
  'wizard.start': async ({ params, respond, context }) => {
    ...
    const session = new WizardSession(
      (prompter) => context.wizardRunner(opts, defaultRuntime, prompter)
    );
    ...
    respond(true, { sessionId, ...result }, void 0);
  },
