/** @module gateway/server-methods/usage -- Usage statistics RPC method handler. */
...
async function loadCostUsageSummaryCached(params) {
  ...
  const entry = cached ?? {};
  const inFlight = loadCostUsageSummary({ days, config: params.config }).then((summary) => {
