/**
 * @module gateway/server-session-key
 * SECURITY: Session key generation and rotation.
 * Resolves session keys for agent runs, ensuring proper scoping
 * and context isolation between concurrent sessions.
 */
