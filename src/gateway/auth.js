/**
 * @module gateway/auth
 * SECURITY: Connection authentication and token validation.
 * Enforces per-message auth checks, timing-safe token comparison,
 * loopback detection, and Tailscale whois identity verification.
 * All auth decisions must use safeEqual() for constant-time comparison.
 */
