/** @module gateway/server-runtime-state -- Gateway runtime state tracking (uptime, connections, health). */
...
async function createGatewayRuntimeState(params) {
  ...
  for (const host of bindHosts) {
    const httpServer2 = createGatewayHttpServer({
      canvasHost,
