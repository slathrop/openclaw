/**
 * @module gateway/protocol/schema/wizard
 * Protocol schemas for the setup wizard: start/next/cancel/status operations,
 * wizard step definitions, and wizard result envelopes.
 */
