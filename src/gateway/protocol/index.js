 ...
 * Gateway protocol validators and re-exports. Compiles TypeBox schemas into Ajv
 * validators for runtime message validation over WebSocket connections.
 */
 ...
 * @param {Array<{keyword?: string, instancePath?: string, params?: object, message?: string}> | null | undefined} errors
 * @returns {string}
 */
