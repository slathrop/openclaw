...
__name(resolveSandboxScript, 'resolveSandboxScript');
...
__name(runSandboxScript, 'runSandboxScript');
...
__name(isDockerAvailable, 'isDockerAvailable');
...
__name(dockerImageExists, 'dockerImageExists');
function resolveSandboxDockerImage(cfg) {
  const image = cfg.agents?.defaults?.sandbox?.docker?.image?.trim();
  return image ? image : DEFAULT_SANDBOX_IMAGE;
}
__name(resolveSandboxDockerImage, 'resolveSandboxDockerImage');
function resolveSandboxBrowserImage(cfg) {
  const image = cfg.agents?.defaults?.sandbox?.browser?.image?.trim();
  return image ? image : DEFAULT_SANDBOX_BROWSER_IMAGE;
}
__name(resolveSandboxBrowserImage, 'resolveSandboxBrowserImage');
...
__name(updateSandboxDockerImage, 'updateSandboxDockerImage');
...
__name(updateSandboxBrowserImage, 'updateSandboxBrowserImage');
...
__name(handleMissingSandboxImage, 'handleMissingSandboxImage');
  ...
  await handleMissingSandboxImage(
    {
      ...
      updateConfig: /* @__PURE__ */ __name((image) => {
...
__name(maybeRepairSandboxImages, 'maybeRepairSandboxImages');
...
__name(noteSandboxScopeWarnings, 'noteSandboxScopeWarnings');
export {
