...
const truncateKey = /* @__PURE__ */ __name((key) => {
...
const colorByPct = /* @__PURE__ */ __name((label, pct, rich) => {
  if (!rich || pct === null) {
    return label;
  }
  if (pct >= 95) {
...
const formatTokensCell = /* @__PURE__ */ __name((total, contextTokens, rich) => {
  if (!total) {
...
const formatKindCell = /* @__PURE__ */ __name((kind, rich) => {
...
__name(classifyKey, 'classifyKey');
...
__name(sessionsCommand, 'sessionsCommand');
export {
  sessionsCommand
};
