...
const multiselectStyled = /* @__PURE__ */ __name((params) => multiselect({
  ...params,
...
__name(buildScopeSelection, 'buildScopeSelection');
...
__name(stopAndUninstallService, 'stopAndUninstallService');
...
__name(removeMacApp, 'removeMacApp');
...
__name(uninstallCommand, 'uninstallCommand');
export {
  uninstallCommand
};
