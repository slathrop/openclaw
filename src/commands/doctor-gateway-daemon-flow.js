...
__name(maybeRepairLaunchAgentBootstrap, 'maybeRepairLaunchAgentBootstrap');
async function maybeRepairGatewayDaemon(params) {
  ...
  let serviceRuntime;
  if (loaded) {
    serviceRuntime = await service.readRuntime(process.env).catch(() => void 0);
  }
...
__name(maybeRepairGatewayDaemon, 'maybeRepairGatewayDaemon');
export {
