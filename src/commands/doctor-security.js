...
// SECURITY: Security audit (config permissions, credential exposure)
...
async function noteSecurityWarnings(cfg) {
  ...
  const bindMode = bindModes.includes(gatewayBind) ? gatewayBind : void 0;
  ...
  const warnDmPolicy = /* @__PURE__ */ __name(async (params) => {
...
__name(noteSecurityWarnings, 'noteSecurityWarnings');
export {
