...
// SECURITY: OAuth device flow token acquisition and storage
...
async function applyAuthChoiceOAuth(params) {
  if (params.authChoice === 'chutes') {
    ...
    const clientId = process.env.CHUTES_CLIENT_ID?.trim() || String(
...
__name(applyAuthChoiceOAuth, 'applyAuthChoiceOAuth');
export {
