...
// SECURITY: Plugin provider credential delegation
...
async function applyAuthChoicePluginProvider(params, options) {
  ...
  const result = await method.run({
    ...
    oauth: {
      createVpsAwareHandlers: /* @__PURE__ */ __name((opts) => createVpsAwareOAuthHandlers(opts), 'createVpsAwareHandlers')
    }
  });
...
__name(applyAuthChoicePluginProvider, 'applyAuthChoicePluginProvider');
export {
