...
// SECURITY: Auth choice option definitions for supported providers
...
__name(buildAuthChoiceOptions, 'buildAuthChoiceOptions');
function buildAuthChoiceGroups(params) {
  ...
  const skipOption = params.includeSkip ? { value: 'skip', label: 'Skip for now' } : void 0;
  return { groups, skipOption };
}
__name(buildAuthChoiceGroups, 'buildAuthChoiceGroups');
export {
