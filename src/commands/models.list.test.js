...
const resolveAuthStorePathForDisplay = vi.fn().mockReturnValue('/tmp/openclaw-agent/auth-profiles.json');
const resolveProfileUnusableUntilForDisplay = vi.fn().mockReturnValue(null);
const resolveEnvApiKey = vi.fn().mockReturnValue(void 0);
const resolveAwsSdkEnvVarName = vi.fn().mockReturnValue(void 0);
const getCustomProviderApiKey = vi.fn().mockReturnValue(void 0);
