...
__name(runNodeTool, 'runNodeTool');
...
__name(normalizeSnippet, 'normalizeSnippet');
...
function parseSearchOutput(raw) {
  ...
  for (const block of blocks) {
    ...
    results.push({ title, link, snippet: snippet || void 0 });
  }
  return results;
}
__name(parseSearchOutput, 'parseSearchOutput');
...
__name(formatLinkLabel, 'formatLinkLabel');
...
__name(renderRichResults, 'renderRichResults');
...
__name(docsSearchCommand, 'docsSearchCommand');
export {
  docsSearchCommand
};
