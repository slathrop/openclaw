...
const normalizeWorkspacePath = /* @__PURE__ */ __name((input) => path.resolve(resolveUserPath(input)), 'normalizeWorkspacePath');
const coerceTrimmed = /* @__PURE__ */ __name((value) => {
...
__name(loadIdentityFromFile, 'loadIdentityFromFile');
...
__name(resolveAgentIdByWorkspace, 'resolveAgentIdByWorkspace');
...
__name(agentsSetIdentityCommand, 'agentsSetIdentityCommand');
export {
