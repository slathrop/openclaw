...
async function agentsAddCommand(opts, runtime = defaultRuntime, params) {
  ...
  if (nonInteractive) {
    ...
    const bindingResult = bindingParse.bindings.length > 0 ? applyAgentBindings(nextConfig, bindingParse.bindings) : { config: nextConfig, added: [], skipped: [], conflicts: [] };
  ...
  try {
    ...
    nextConfig = await setupChannels(nextConfig, runtime, prompter, {
      ...
      onAccountId: /* @__PURE__ */ __name((channel, accountId) => {
...
__name(agentsAddCommand, 'agentsAddCommand');
export {
  agentsAddCommand
};
