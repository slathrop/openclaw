...
// SECURITY: MiniMax auth configuration during onboarding
import {
...
__name(applyMinimaxProviderConfig, 'applyMinimaxProviderConfig');
...
__name(applyMinimaxHostedProviderConfig, 'applyMinimaxHostedProviderConfig');
...
__name(applyMinimaxConfig, 'applyMinimaxConfig');
...
__name(applyMinimaxHostedConfig, 'applyMinimaxHostedConfig');
...
__name(applyMinimaxApiProviderConfig, 'applyMinimaxApiProviderConfig');
...
__name(applyMinimaxApiConfig, 'applyMinimaxApiConfig');
export {
