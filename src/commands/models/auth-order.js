...
__name(modelsAuthOrderGetCommand, 'modelsAuthOrderGetCommand');
...
__name(modelsAuthOrderClearCommand, 'modelsAuthOrderClearCommand');
...
__name(modelsAuthOrderSetCommand, 'modelsAuthOrderSetCommand');
export {
