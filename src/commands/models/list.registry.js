...
const isLocalBaseUrl = /* @__PURE__ */ __name((baseUrl) => {
  try {
...
const hasAuthForProvider = /* @__PURE__ */ __name((provider, cfg, authStore) => {
...
__name(loadModelRegistry, 'loadModelRegistry');
