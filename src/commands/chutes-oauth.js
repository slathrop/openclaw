...
// SECURITY: Chutes platform OAuth token exchange
...
__name(waitForLocalCallback, 'waitForLocalCallback');
async function loginChutes(params) {
  ...
  const timeoutMs = params.timeoutMs ?? 3 * 60 * 1e3;
...
__name(loginChutes, 'loginChutes');
export {
  loginChutes
};
