...
function formatGatewayChannelsStatusLines(payload) {
  ...
  const accountLines = /* @__PURE__ */ __name((provider, accounts) => accounts.map((account) => {
    const bits = [];
...
__name(formatGatewayChannelsStatusLines, 'formatGatewayChannelsStatusLines');
...
__name(formatConfigChannelsStatusLines, 'formatConfigChannelsStatusLines');
...
__name(channelsStatusCommand, 'channelsStatusCommand');
export {
