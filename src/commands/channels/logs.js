...
const MAX_BYTES = 1e6;
const getChannelSet = /* @__PURE__ */ __name(() => /* @__PURE__ */ new Set([...listChannelPlugins().map((plugin) => plugin.id), 'all']), 'getChannelSet');
...
__name(parseChannelFilter, 'parseChannelFilter');
...
__name(matchesChannel, 'matchesChannel');
...
__name(readTailLines, 'readTailLines');
...
__name(channelsLogsCommand, 'channelsLogsCommand');
export {
  channelsLogsCommand
};
