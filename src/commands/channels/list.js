...
const colorValue = /* @__PURE__ */ __name((value) => {
  if (value === 'none') {
...
__name(formatLinked, 'formatLinked');
function shouldShowConfigured(channel) {
  return channel.meta.showConfigured !== false;
}
__name(shouldShowConfigured, 'shouldShowConfigured');
...
__name(formatAccountLine, 'formatAccountLine');
...
__name(loadUsageWithProgress, 'loadUsageWithProgress');
...
__name(channelsListCommand, 'channelsListCommand');
export {
  channelsListCommand
};
