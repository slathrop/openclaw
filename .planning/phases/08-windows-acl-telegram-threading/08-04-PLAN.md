...
<task type="auto">
  <name>Task 3: SYNC-033 - Streamline start and install docs</name>
  <files>docs/start/**, docs/install/**, docs/docs.json</files>
  <action>
Port commit 675c26b2b (Docs: streamline start and install docs (#9648))
...
3. Commit:
  ...
  <verify>`git log -1` shows correct message; changed docs files exist and have valid markdown</verify>
  <done>Commit 675c26b2b ported as SYNC-033, start and install docs streamlined</done>
</task>

<task type="auto">
  <name>Task 4: SYNC-034 - Rename install overview page</name>
  <files>docs/install/**, docs/docs.json</files>
  <action>
Port commit 34424ce53 (docs(install): rename install overview page)
...
3. Commit:
  ...
  <verify>`git log -1` shows correct message; old filename no longer exists, new filename present</verify>
  <done>Commit 34424ce53 ported as SYNC-034, install overview page renamed with updated references</done>
</task>
